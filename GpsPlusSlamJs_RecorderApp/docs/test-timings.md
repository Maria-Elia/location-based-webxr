...
Last recorded 2026-09-17T09:03:39.477Z · machine `c7aff3e4 (AMD Ryzen 5 3600 6-Core Processor, 12 threads)` · branch `main` @ `09cec4b4`

_Header describes the most recent write only; standalone stage runs update single rows. Median = the stage's same-machine history median. Per-recording provenance lives in the JSON block._

| Stage | Duration | Δ duration | Median | Tests | Δ tests | Flag |
| --- | ---: | ---: | ---: | --- | ---: | --- |
| `format` | 6.5 s | – | 6.5 s | – | – | baseline reset |
| `lint` | 15.0 s | – | 15.0 s | – | – | baseline reset |
| `lint:css` | 0.6 s | – | 0.6 s | – | – | baseline reset |
| `check:dup` | 2.0 s | – | 2.0 s | – | – | baseline reset |
| `check:cycles` | 1.8 s | – | 1.8 s | – | – | baseline reset |
| `check:boundaries` | 2.9 s | – | 2.9 s | – | – | baseline reset |
| `typecheck` | 3.7 s | – | 3.7 s | – | – | baseline reset |
| `typecheck:tests` | 6.1 s | – | 6.1 s | – | – | baseline reset |
| `test:unit` | 15.8 s | – | 15.8 s | 2122 passed, 3 skipped | – | baseline reset |
| `build:framework` | 0.0 s | – | 0.0 s | – | – | baseline reset |
...
- `format`: 6.5, 8.5*, 7.5*, 6.7*, 8.7*, 6.3*, 6.8*, 6.3*, 7.0*, 15.6*
- `lint`: 15.0, 19.6*, 19.5*, 15.7*, 24.8*, 15.3*, 16.2*, 15.7*, 15.2*, 39.0*
- `lint:css`: 0.6, 1.2*, 2.1*, 1.3*, 1.3*, 1.2*, 1.4*, 1.1*, 1.2*, 1.1*
- `check:dup`: 2.0, 3.3*, 4.0*, 3.0*, 3.4*, 2.9*, 3.1*, 2.7*, 3.0*, 3.2*
- `check:cycles`: 1.8, 5.5*, 3.1*, 2.3*, 2.5*, 2.1*, 2.8*, 1.9*, 2.3*, 2.4*
- `check:boundaries`: 2.9, 9.8*, 5.5*, 3.4*, 4.3*, 3.2*, 3.9*, 3.0*, 3.3*, 3.5*
- `typecheck`: 3.7, 4.9*, 14.5*, 2.1*, 2.7*, 4.2*, 2.2*, 2.1*, 2.9*, 4.3*
- `typecheck:tests`: 6.1, 5.9*, 20.5*, 2.3*, 3.4*, 6.9*, 2.5*, 3.2*, 4.0*, 7.5*
- `test:unit`: 15.8, 91.5*, 94.2*, 42.9*, 42.9*, 41.3*, 37.9*, 35.9*, 41.6*, 48.8*
- `build:framework`: 0.0, 10.2*, 11.9*, 0.2*, 0.3*, 0.1*, 0.2*, 5.9*, 0.2*, 0.2*
...
{
  "version": 1,
  "meta": {"project":"GpsPlusSlamJs_RecorderApp","lastWrite":{"ts":"2026-09-17T09:03:39.477Z","machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","machineLabel":"c7aff3e4 (AMD Ryzen 5 3600 6-Core Processor, 12 threads)","git":"09cec4b4","branch":"main"}},
  "stages": {
    "format": { "history": [
      {"ts":"2026-09-17T09:02:51.400Z","durationMs":6465,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "lint": { "history": [
      {"ts":"2026-09-17T09:03:06.437Z","durationMs":15029,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "lint:css": { "history": [
      {"ts":"2026-09-17T09:03:07.090Z","durationMs":646,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "check:dup": { "history": [
      {"ts":"2026-09-17T09:03:09.147Z","durationMs":2050,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "check:cycles": { "history": [
      {"ts":"2026-09-17T09:03:10.918Z","durationMs":1763,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "check:boundaries": { "history": [
      {"ts":"2026-09-17T09:03:13.836Z","durationMs":2911,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "typecheck": { "history": [
      {"ts":"2026-09-17T09:03:17.527Z","durationMs":3683,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "typecheck:tests": { "history": [
      {"ts":"2026-09-17T09:03:23.643Z","durationMs":6109,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "test:unit": { "history": [
      {"ts":"2026-09-17T09:03:39.427Z","durationMs":15751,"tests":{"passed":2122,"failed":0,"skipped":3,"todo":0},"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "build:framework": { "history": [
      {"ts":"2026-09-17T09:03:39.477Z","durationMs":42,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
