...
Last recorded 2026-09-17T09:01:52.579Z · machine `c7aff3e4 (AMD Ryzen 5 3600 6-Core Processor, 12 threads)` · branch `main` @ `09cec4b4`

_Header describes the most recent write only; standalone stage runs update single rows. Median = the stage's same-machine history median. Per-recording provenance lives in the JSON block._

| Stage | Duration | Δ duration | Median | Tests | Δ tests | Flag |
| --- | ---: | ---: | ---: | --- | ---: | --- |
| `format` | 8.9 s | – | 8.9 s | – | – | baseline reset |
| `lint` | 21.8 s | – | 21.8 s | – | – | baseline reset |
| `check:cycles` | 1.6 s | – | 1.6 s | – | – | baseline reset |
| `typecheck` | 1.7 s | – | 1.7 s | – | – | baseline reset |
| `typecheck:tests` | 2.4 s | – | 2.4 s | – | – | baseline reset |
| `test:unit` | 28.4 s | – | 28.4 s | 3236 passed, 13 skipped | – | baseline reset |
| **total** | 64.8 s | – | 64.8 s | 3236 passed, 13 skipped | – | baseline reset |
...
- `format`: 8.9, 9.8*, 10.9*, 13.1*, 10.8*, 9.7*, 8.8*, 10.1*, 8.5*, 12.4*
- `lint`: 21.8, 23.8*, 24.9*, 25.3*, 22.9*, 19.0*, 20.0*, 21.8*, 19.3*, 44.5*
- `check:cycles`: 1.6, 1.7*, 1.9*, 2.0*, 5.0*, 1.9*, 2.0*, 1.8*, 1.6*, 4.9*
- `typecheck`: 1.7, 1.6*, 3.5*, 1.7*, 2.1*, 1.7*, 2.0*, 2.1*, 2.0*, 4.9*
- `typecheck:tests`: 2.4, 2.2*, 6.8*, 2.7*, 3.1*, 2.6*, 2.9*, 3.1*, 2.5*, 7.2*
- `test:unit`: 28.4, 75.6*, 87.1*, 82.5*, 95.5*, 67.9*, 79.0*, 65.5*, 81.7*, 105.0*
- `total`: 64.8, 115.1*, 135.5*, 127.8*, 139.8*, 103.2*, 115.1*, 104.8*, 116.1*, 180.1*

```json
{
  "version": 1,
  "meta": {"project":"GpsPlusSlamJs_AppFramework","lastWrite":{"ts":"2026-09-17T09:01:52.579Z","machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","machineLabel":"c7aff3e4 (AMD Ryzen 5 3600 6-Core Processor, 12 threads)","git":"09cec4b4","branch":"main"}},
  "stages": {
    "format": { "history": [
      {"ts":"2026-09-17T09:00:56.672Z","durationMs":8905,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "lint": { "history": [
      {"ts":"2026-09-17T09:01:18.444Z","durationMs":21764,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "typecheck": { "history": [
      {"ts":"2026-09-17T09:01:21.699Z","durationMs":1670,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "typecheck:tests": { "history": [
      {"ts":"2026-09-17T09:01:24.094Z","durationMs":2387,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "test:unit": { "history": [
      {"ts":"2026-09-17T09:01:52.571Z","durationMs":28424,"tests":{"passed":3236,"failed":0,"skipped":13,"todo":0},"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "total": { "history": [
      {"ts":"2026-09-17T09:01:52.579Z","durationMs":64816,"tests":{"passed":3236,"failed":0,"skipped":13,"todo":0},"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
    ...
    "check:cycles": { "history": [
      {"ts":"2026-09-17T09:01:20.022Z","durationMs":1571,"tests":null,"machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","git":"09cec4b4"},
