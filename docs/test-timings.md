...
Last recorded 2026-09-15T11:20:08.688Z · machine `c7aff3e4 (AMD Ryzen 5 3600 6-Core Processor, 12 threads)` · branch `fix/ar-error` @ `db6c9d6f`
...
- `check:deadcode`: 4.4, 3.5, 3.6, 4.6*, 9.3*, 3.6*, 4.1*, 5.6*, 5.1*, 11.7*
...
{
  "version": 1,
  "meta": {"project":"location-based-webxr","lastWrite":{"ts":"2026-09-15T11:20:08.688Z","machine":"c7aff3e4|AMD-Ryzen-5-3600-6-Core-Processor|12","machineLabel":"c7aff3e4 (AMD Ryzen 5 3600 6-Core Processor, 12 threads)","git":"db6c9d6f","branch":"fix/ar-error"}},
  "stages": {
